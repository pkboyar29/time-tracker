...
import { createActivity, updateActivity } from '../../redux/slices/activitySlice'
...
const ActivityManageForm: FC<ActivityManageFormProps> = ({ currentActivity, afterSubmitHandler }) => {

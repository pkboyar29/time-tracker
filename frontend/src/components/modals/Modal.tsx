...
const Modal: FC<ModalProps> = ({ children, title, onCloseModal }) => {
  ...
  return (
    ...
    >
      <div
        ref={modalRef}
        className="px-3 py-5 overflow-hidden border border-solid rounded-md bg-surfaceLight dark:bg-surfaceDark basis-5/6 md:basis-2/3 xl:basis-1/3 border-gray-300/80 dark:border-gray-500"
      >

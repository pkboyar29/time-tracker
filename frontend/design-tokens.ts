export const colors = {
  primary: '#E83333',
  primaryHover: '#b91c1c',
  backgroundLight: '#f0f0f0', // in light mode
  surfaceLight: '#fff', // in light mode, for panels/cards/modal
  surfaceLightHover: '#F1F1F1', // in light mode, when overing the panels/cards with surfaceLight background
  backgroundDark: '#1e1e1e', // in dark mode
  backgroundDarkHover: 'rgba(44,44,44,0.9)', // in dark mode, when hovering the area with backgroundDark background
